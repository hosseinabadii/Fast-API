...
Revision ID: 79190fe5daf0
Revises: 
Create Date: 2024-09-17 19:45:18.777352
...
def upgrade() -> None:
    ...
    sa.Column('title', sa.String(length=200), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('type', sa.Enum('LESSON', 'QUIZ', 'ASSIGNMENT', name='contenttype'), nullable=False),
